...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    ...
    Desribe is essentially just markup to make your tests easier to read. you can section tests of within describe blocks.
...
1. Mention three types of automated tests.
    ...
    snapshot testing, unit testing, and component testing (really the main trhee we focused on this week.)
